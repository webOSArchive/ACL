    ...
    components: [
        ...
        },
        {
            ...
            components: [
                ...
                },
                {
                    kind: "Button",
                    name: "btnActivateACL",
                    caption: "Activate or Try ACL for webOS on my TouchPad",
                    onclick: "btnTryOrActivate",
                    className: "blue-btn"
                },
            ]
        },
        ...
        },
        {
            ...
            components: [
                ...
                {
                    kind: "Button",
                    caption: "Buy ACL for webOS for your TouchPad",
                    onclick: "btnBuyACL",
                    className: "discover-grey-btn",
                },
                {
                    kind: "Button",
                    caption: "Sign up for Email Alerts about ACL for webOS",
                    onclick:"btnEmailAlert",
                    className: "discover-grey-btn",
                },
                {
                    kind: "Image",
        ...
        },
        {
            ...
            components: [
                ...
                },
                {
                    kind: "Input",
                    name: "ACLKey",
                    hint: "Click here to enter your ACL for webOS license key",
                    style: "width: 445px; font-weight:bold; margin: 0 auto",
                    changeOnInput: true,
                    onchange: "EnterACLKey"
                },
                {
                    kind: "Button",
                    caption: "Activate license",
                    name: "btnActivateLicense",
                    onclick: "btnActivateLicense",
                    className: "green-btn",
                    style: "width: 420px"
                },
/*              {
                    kind: "Control",
                    content: "Want to try ACL on your Touchpad now before buying a license?",
                    className: "txt-purchase"
                },
                {
                    kind: "Button",
                ...
                {
                    kind: "Control",
                    content: "Don't have a license code? Purchase your license now to enable Android apps to run on  your Touchpad!",
                    className: "txt-purchase"
                },
                {
                    kind: "Button",
    ...
    menuGotoRealease: function(){
        this.$.launchBrowserCall.call({"id": "com.palm.app.browser",
            "params":{"target": "http://support.openmobileww.com/hc/en-us/articles/201057597-ACL-for-webOS-v1-0-0-Release-Notes"}});
    },
    ...
    onWindowCreate: function(inSender, inEvent) {
        console.log("onWindowCreate [BYPASSED - Auto-activated due to offline servers]");
        this.$.splash.destroy();
        // Always set EULA accepted and go to activated state
        ...
        this.phase = 2;
        this.currentAppMenu = this.$.AppMenuPhase2;
        this.$.aclforwebosWindow.openAtCenter();
        this.$.currentWindow = this.$.aclforwebosWindow;
        this.refreshAppMenu(this.phase);
        this.pageOpenigSequence = this.pageOpenigSequence + "aclforwebos";
    },
